...
namespace AEX {
	...
	// 1. text and atlas are both null -> draw with vertex color
	// 2. atlas is null, tex is valid -> draw as regular tex
	// 3. tex is null, atlas is valid -> draw with atlas
	...
	*/
	...
	void Renderable::SetTexture(TResource<Texture>* tex)
	{
		mpTexture = tex;
	}
